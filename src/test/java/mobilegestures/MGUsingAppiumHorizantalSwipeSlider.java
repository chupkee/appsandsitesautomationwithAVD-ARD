...
public class MGUsingAppiumHorizantalSwipeSlider 
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			//slider
			//swipe lift to right and right to lift Horizontal swipe
		    //Get element dimension
			MobileElement ele=(MobileElement) driver.findElement(By.xpath("//*[@content-desc='slider']"));
			int width=driver.manage().window().getSize().getWidth();
			int height=driver.manage().window().getSize().getHeight();
