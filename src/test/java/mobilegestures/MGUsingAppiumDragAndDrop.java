...
public class MGUsingAppiumDragAndDrop 
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			int dragx1=ele1.getCenter().x;
			int dragy1=ele1.getCenter().y;
			int dropx2=ele2.getCenter().x;
			int dropy2=ele2.getCenter().y;
			
			ta.press(ElementOption.element(ele1)).moveTo(ElementOption.element(ele2)).release().perform();
			//ta.press(ElementOption.point(dragx1,dragy1)).moveTo(ElementOption.point(dropx2,dropy2)).release().perform();
